...
/**com_zhidao_customrecod  com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge
 * 编码准备，写入配置信息
 */
extern "C"
JNIEXPORT jint JNICALL
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_prepareJXFFmpegEncoder(JNIEnv *env,
                                                                                        jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_encodeFrame2H264(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jbyteArray data_) {
...
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_getFFmpegConfig(JNIEnv *env,
                                                                                 jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_encodeFrame2AAC(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_recordEnd(JNIEnv *env,
                                                                           jclass type) {
...
Java_com_zhidao_customrecod_smallrecod_jniinterface_FFmpegBridge_nativeRelease(JNIEnv *env,
                                                                               jclass type) {
